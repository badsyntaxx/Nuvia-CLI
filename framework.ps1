$global:commandMap = [ordered]@{
    ...
    "ezsever version"                = @("nuvia", "Vatech", "getEZServerVersion", "Get the EZServer version number.")
    "vatech config"                  = @("nuvia", "Vatech", "getVTServerConfig", "Get the EZDent VTServerConfig.")
