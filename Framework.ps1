$global:commandMap = [ordered]@{
    ...
    "get od version"                 = @("nuvia", "Clinic OpenDental", "getODVersion", "Get the OpenDental version.")
    "od get config"                  = @("nuvia", "Clinic OpenDental", "getODConfig", "Get the OpenDental configuration.")
    "get od config"                  = @("nuvia", "Clinic OpenDental", "getODConfig", "Get the OpenDental configuration.")
