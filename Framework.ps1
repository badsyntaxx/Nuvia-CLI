$global:commandMap = [ordered]@{
    ...
    "od get ver"                     = @("nuvia", "OpenDental", "getODVersion", "Get the OpenDental version.")
    "od get conf"                    = @("nuvia", "OpenDental", "getODConfig", "Get the OpenDental configuration.")
    "od install 24341"               = @("nuvia", "OpenDental", "install24341", "Install OpenDental version 24341.")
    "vatech get ezdent ver"          = @("nuvia", "EZDent", "getEZDentVersion", "Get the EZDent version number.")
    "vatech get ezsever ver"         = @("nuvia", "EZDent", "getEZServerVersion", "Get the EZServer version number.")
    "vatech get vtserverconfig"      = @("nuvia", "EZDent", "getVTServerConfig", "Get the EZDent VTServerConfig.")
    "i tscan"                        = @("nuvia", "Install Tscan", "installTscan", "Install Tscan.")
