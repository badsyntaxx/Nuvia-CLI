$global:commandMap = [ordered]@{
    ...
    "od get config"                  = @("nuvia", "OpenDental", "getODConfig", "Get the OpenDental configuration.")
    ...
    "vatech get config"              = @("nuvia", "EZDent", "getVTServerConfig", "Get the EZDent VTServerConfig.")
