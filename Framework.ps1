$global:commandMap = [ordered]@{
    ...
    "od verion"                      = @("nuvia", "OpenDental", "getODVersion", "Get the OpenDental version.")
    ...
    "ezdent ver"                     = @("nuvia", "EZDent", "getEZDentVersion", "Get the EZDent version number.")
    "ezsever ver"                    = @("nuvia", "EZDent", "getEZServerVersion", "Get the EZServer version number.")
